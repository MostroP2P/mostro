...
## What's Changed in 0.18.4

### 🐛 Bug Fixes


* fix: persist taken_at in the pre-trade take CAS writes by [@Catrya](https://github.com/Catrya) in [#876](https://github.com/MostroP2P/mostro/pull/876)

## Contributors
* [@Catrya](https://github.com/Catrya) made their contribution in [#876](https://github.com/MostroP2P/mostro/pull/876)

**Full Changelog**: https://github.com/MostroP2P/mostro/compare/v0.18.3...0.18.4
