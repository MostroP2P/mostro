...
- Lightning Operations: LIGHTNING_OPS.md (includes the runbook for migrating to a different Lightning node)
...
- Ortsom on Pull Requests: ORTSOM_PR_E2E_SPEC.md (design spec for the automated e2e gate; label-only at first)
