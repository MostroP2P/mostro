...
The published report lives at **<https://mostrop2p.github.io/mostro/>** — the
same browsable HTML `cargo llvm-cov --html` produces locally, regenerated by
the `Coverage` workflow every Sunday and on demand from the Actions tab.
